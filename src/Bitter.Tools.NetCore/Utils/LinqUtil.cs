...
namespace System.Data
{
    ...
    internal class ExpressionParser
    {
        ...
        private Dictionary<string, Type> symTypes;
        ...
        private char ch;
        private Token token;
        private string currentMothedName = "";
        ...
        private void ProcessValues(object[] values, Type[] types)
        {
            for (int i = 0; i < values.Length; i++)
            {
                object value = values[i];
        ...
        private void AddSymbol(string name, object value, Type returnType)
        {
            if (symbols.ContainsKey(name))
                throw ParseError(Res.DuplicateIdentifier, name);
            symbols.Add(name, value);
